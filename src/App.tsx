...
function App() {
  ...
  //set event handle
  //ติดปัญหาที่ปุ้มเปลี่ยนหน้าใน NavBar ยังมีค่าคงค้างจากการกดปุ่มก่อนหน้าอยู่ ทำให้เมื่อกดปุ่มเปลี่ยนหน้าแล้วค่าที่ส่งไปที่ App ยังเป็นค่าของหน้าก่อนหน้าอยู่ ซึ่งทำให้หน้าไม่เปลี่ยนตามที่ต้องการ
